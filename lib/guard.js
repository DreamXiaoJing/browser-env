    ...
    (function() {
      ...
      Function.prototype.toString = function() {
        ...
        if (this !== undefined && this !== null) {
          ...
          if (ownToString && typeof ownToString.value === 'function') {
            // 自引用情况：ownToString.value === this（makeNative 中的 tsTsFn 模式）
            // 直接调用 ownToString.value() 会无限递归，fallthrough 到 nativeToString
            // 又会暴露源码，因此这里直接构造对应的 native 字符串
            if (ownToString.value === this) {
              var selfName = this.name || 'anonymous';
              return 'function ' + selfName + '() ' + nativeCodeStr;
            }
